...
/// <summary>
/// FcdLoadPort (富创得 LP300) 仿真器入口。
/// 可选参数 --data &lt;目录&gt; 指定本实例的数据目录（config.json / responses.json / fault.* 旗标），
/// 同机跑多实例（LoadPort1/LoadPort2）时各给一个目录互不干扰；默认落在 exe 旁。
/// </summary>
public partial class App : Application
{
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        // 进程级崩溃钩子 (原先在面板里注册, 面板化后上移至此, 一进程只此一份)
